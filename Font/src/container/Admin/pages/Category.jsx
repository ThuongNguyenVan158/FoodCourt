    ...
    const {name,img_url} =newCate;
     const handleInputChange=(e)=>
     {
      ...
      const handleAdd= async(e)=>{
        ...
        await axios.post("http://localhost:5000/api/v1/category/addCategory",newCate);
                            ...
                            <div className="card__header1">
                             ...
                             <div className="input-group mb-4 mt-3">
                                <div className="form-outline">
                                    <input type="text" id="form1" onChange={(e)=>setSearch(e.target.value)} className="form-control" placeholder="Tìm kiếm" style={{backgroundColor:"#ececec"}}/>
                                </div>
