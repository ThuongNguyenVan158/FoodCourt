...
const renderSignInPage = (event) => {
    ...
    document.getElementById("signInPage").style.transition = '0.7s 0.5s ease-in-out';
...
const renderSignUpPage = (event) => {
    document.getElementById("signUpPage").style.transition = '0.7s 0.5s ease-in-out';
            ...
            <div className={classes.flexBox}>
                    ...
                    <div className={classes.boxSignIn}>
                        <div className={classes.it}>
                            <div className={classes.btnChangePage}>
                                <Button onClick={renderSignUpPage} variant="contained" color="primary">
                                    Sign Up
                                </Button>
                            </div>
                        </div>
                ...
                <div className={classes.signUp} id="signUpPage">
                    <div className={classes.boxSignUp}>
                        ...
                        <div className={classes.it}>
                            <div className={classes.btnChangePage}>
                                <Button onClick={renderSignInPage} variant="contained" color="primary">
                                    Sign IN
                                </Button>
                            </div>
                        </div>
